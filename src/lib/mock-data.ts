...
const userImages = {
  ...
  saniya: PlaceHolderImages.find((p) => p.id === 'user-avatar-5')!.imageUrl,
  asmita: PlaceHolderImages.find((p) => p.id === 'user-avatar-6')!.imageUrl,
  komal: PlaceHolderImages.find((p) => p.id === 'user-avatar-7')!.imageUrl,
  kalyani: PlaceHolderImages.find((p) => p.id === 'user-avatar-8')!.imageUrl,
...
export const users: User[] = [
  ...
  { id: 'user-5', name: 'Saniya Parange', email: 'saniya.parange@example.com', avatar: userImages.saniya, role: 'Executive' },
  { id: 'user-6', name: 'Asmita Pawar', email: 'asmita.pawar@example.com', avatar: userImages.asmita, role: 'Executive' },
  { id: 'user-7', name: 'Komal Badekar', email: 'komal.badekar@example.com', avatar: userImages.komal, role: 'Executive' },
  { id: 'user-8', name: 'Kalyani Palande', email: 'kalyani.palande@example.com', avatar: userImages.kalyani, role: 'Executive' },
];
...
export const enquiries: Enquiry[] = [
  ...
  {
    id: 'ENQ-006',
    customerName: 'Nikhil Kotre',
    phone: '9320202005',
    email: 'nikhil.kotre@example.com',
    type: 'One Day Picnic',
    status: 'Day Booked',
    source: 'Toll Free',
    priority: 'High',
    assignedTo: users[4],
    createdAt: new Date('2025-09-21T09:48:00Z'),
    updatedAt: new Date('2025-09-21T09:48:00Z'),
    details: 'Enquiry for one day picnic for a corporate group of 50 people.',
    followUps: [],
    activityLog: [],
  },
  {
    id: 'ENQ-007',
    customerName: 'Kashish Thakre',
    phone: '8356067833',
    email: 'kashish.thakre@example.com',
    type: 'One Day Picnic',
    status: 'Day Booked',
    source: 'Toll Free',
    priority: 'High',
    assignedTo: users[4],
    createdAt: new Date('2025-09-21T09:43:00Z'),
    updatedAt: new Date('2025-09-21T09:43:00Z'),
    details: 'Family booking for one day picnic.',
    followUps: [],
    activityLog: [],
  },
  {
    id: 'ENQ-008',
    customerName: 'Mehwish Khan',
    phone: '9930089878',
    email: 'mehwish.khan@example.com',
    type: 'One Day Picnic',
    status: 'Day Booked',
    source: 'Toll Free',
    priority: 'High',
    assignedTo: users[5],
    createdAt: new Date('2025-09-20T05:32:00Z'),
    updatedAt: new Date('2025-09-20T05:32:00Z'),
    details: 'School trip for 100 students.',
    followUps: [],
    activityLog: [],
  },
  {
    id: 'ENQ-009',
    customerName: 'Vaibhav Shah',
    phone: '8928844986',
    email: 'vaibhav.shah@example.com',
    type: 'One Day Picnic',
    status: 'Day Booked',
    source: 'Toll Free',
    priority: 'High',
    assignedTo: users[6],
    createdAt: new Date('2025-09-20T04:51:00Z'),
    updatedAt: new Date('2025-09-20T04:51:00Z'),
    details: 'Looking to book for a birthday party.',
    followUps: [],
    activityLog: [],
  },
  {
    id: 'ENQ-010',
    customerName: 'Jagdish Salian',
    phone: '9820150383',
    email: 'jagdish.salian@example.com',
    type: 'One Day Picnic',
    status: 'Day Booked',
    source: 'Other',
    priority: 'Low',
    assignedTo: users[7],
    createdAt: new Date('2025-09-20T04:43:00Z'),
    updatedAt: new Date('2025-09-20T04:43:00Z'),
    details: 'General enquiry about package details.',
    followUps: [],
    activityLog: [],
  },
];
